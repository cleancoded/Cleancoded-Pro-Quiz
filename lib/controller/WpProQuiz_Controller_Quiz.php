...
class WpProQuiz_Controller_Quiz extends WpProQuiz_Controller_Controller
{
    ...
    private function showActionHook()
    {
        ...
        add_screen_option('per_page', array(
            'label' => __('Quiz', 'Cleancoded-Pro-Quiz'),
            'default' => 20,
    ...
    private function addEditQuiz()
    {
        ...
        if ($quizId && $quizMapper->exists($quizId) == 0) {
            WpProQuiz_View_View::admin_notices(__('Quiz not found', 'Cleancoded-Pro-Quiz'), 'error');
        ...
        if (isset($this->_post['template']) || (isset($this->_post['templateLoad']) && isset($this->_post['templateLoadId']))) {
            ...
            if (isset($this->_post['submit'])) {
                ...
                if ($this->checkValidit($this->_post)) {
                    if ($quizId) {
                        WpProQuiz_View_View::admin_notices(__('Quiz edited', 'Cleancoded-Pro-Quiz'), 'info');
                    } else {
                        WpProQuiz_View_View::admin_notices(__('quiz created', 'Cleancoded-Pro-Quiz'), 'info');
                    }
        ...
        $view->header = $quizId ? __('Edit quiz', 'Cleancoded-Pro-Quiz') : __('Create quiz', 'Cleancoded-Pro-Quiz');
...
//        }
    ...
    private function saveTemplate()
    {
        ...
        WpProQuiz_View_View::admin_notices(__('Template stored', 'Cleancoded-Pro-Quiz'), 'info');
    ...
    private function deleteAction($id)
    {
        ...
        WpProQuiz_View_View::admin_notices(__('Quiz deleted', 'Cleancoded-Pro-Quiz'), 'info');
    ...
    private function setCategoryOverview($catArray, $categories)
    {
        ...
        $a = __('Categories', 'Cleancoded-Pro-Quiz') . ":\n";
