...
class WpProQuiz_Controller_GlobalSettings extends WpProQuiz_Controller_Controller
{
    ...
    private function edit()
    {
        ...
        if (isset($this->_post['submit'])) {
            ...
            WpProQuiz_View_View::admin_notices(__('Settings saved', 'Cleancoded-Pro-Quiz'), 'info');
            ...
            if (isset($this->_post['databaseFix'])) {
                WpProQuiz_View_View::admin_notices(__('Database repaired', 'Cleancoded-Pro-Quiz'), 'info');
