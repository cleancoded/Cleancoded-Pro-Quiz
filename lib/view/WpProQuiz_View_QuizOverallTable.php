...
class WpProQuiz_View_QuizOverallTable extends WP_List_Table
{
    ...
    public static function getColumnDefs()
    {
        $columns = array(
            ...
            'name' => __('Name', 'Cleancoded-Pro-Quiz'),
            'category' => __('Category', 'Cleancoded-Pro-Quiz'),
            'shortcode' => __('Shortcode', 'Cleancoded-Pro-Quiz'),
            'shortcode_leaderboard' => __('Shortcode-Leaderboard', 'Cleancoded-Pro-Quiz')
        );
    ...
    function __construct($quizItems, $quizCount, $categoryItems, $perPage)
    {
        parent::__construct(array(
            'singular' => __('Quiz', 'Cleancoded-Pro-Quiz'),
            'plural' => __('Quiz', 'Cleancoded-Pro-Quiz'),
            'ajax' => false,
    ...
    function no_items()
    {
        _e('No data available', 'Cleancoded-Pro-Quiz');
    }
    ...
    function get_bulk_actions()
    {
        ...
        if (current_user_can('wpProQuiz_delete_quiz')) {
            $actions['delete'] = __('Delete', 'Cleancoded-Pro-Quiz');
        }

        if (current_user_can('wpProQuiz_export')) {
            $actions['export'] = __('Export', 'Cleancoded-Pro-Quiz');
        }

        if (current_user_can('wpProQuiz_edit_quiz')) {
            $actions['set_category'] = __('Set Category', 'Cleancoded-Pro-Quiz');
        }
