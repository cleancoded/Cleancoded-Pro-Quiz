...
class WpProQuiz_View_QuizEdit extends WpProQuiz_View_View
{
        ...
        <div class="wrap wpProQuiz_quizEdit">
            ...
            <form method="post"
                ...
                <a style="float: left;" class="button-secondary" href="<?php echo admin_url('admin.php?page=wpProQuiz'); ?>">
                    <?php _e('back to overview', 'Cleancoded-Pro-Quiz'); ?>
                </a>
                ...
                <div style="float: right;">
                    ...
                    <input type="submit" name="templateLoad" value="<?php _e('load template', 'Cleancoded-Pro-Quiz'); ?>"
                ...
                <div id="poststuff">
                    ...
                    <div style="float: right;">
                        <input type="text" placeholder="<?php _e('template name', 'Cleancoded-Pro-Quiz'); ?>"
                               class="regular-text" name="templateName" style="border: 1px solid rgb(255, 134, 134);">
                        <select name="templateSaveList">
                            <option value="0">=== <?php _e('Create new template', 'Cleancoded-Pro-Quiz'); ?> ===</option>
                            <?php
                            foreach ($this->templates as $template) {
                                echo '<option value="', $template->getTemplateId(), '">', esc_html($template->getName()), '</option>';
                            }
                        ...
                        <input type="submit" name="template" class="button-primary" id="wpProQuiz_saveTemplate"
                               value="<?php _e('Save as template', 'Cleancoded-Pro-Quiz'); ?>">
                    </div>
                    <div style="clear: both;"></div>
                </div>
            </form>
    ...
    private function tabBar()
    {
        ...
        <div class="nav-tab-wrapper wpProQuiz-top-tab-wrapper">
            <a href="#tabGeneral" data-tab="tabGeneral" class="nav-tab nav-tab-active"><?php _e('General', 'Cleancoded-Pro-Quiz'); ?></a>
            <a href="#tabResult" data-tab="tabResult" class="nav-tab "><?php _e('Result', 'Cleancoded-Pro-Quiz'); ?></a>
            <a href="#tabOptions" data-tab="tabOptions" class="nav-tab "><?php _e('Options', 'Cleancoded-Pro-Quiz'); ?></a>
            <a href="#tabCustomFields" data-tab="tabCustomFields" class="nav-tab "><?php _e('Custom fields', 'Cleancoded-Pro-Quiz'); ?></a>
            <a href="#tabLeaderboard" data-tab="tabLeaderboard" class="nav-tab "><?php _e('Leaderboard', 'Cleancoded-Pro-Quiz'); ?></a>
            <a href="#tabEmailSettings" data-tab="tabEmailSettings" class="nav-tab "><?php _e('Email Settings', 'Cleancoded-Pro-Quiz'); ?></a>
            <a href="#tabPlugins" data-tab="tabPlugins" class="nav-tab "><?php _e('Plugins', 'Cleancoded-Pro-Quiz'); ?></a>
    ...
    private function postBoxOptions()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Options', 'Cleancoded-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide quiz title', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide title', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                ...
                                <p class="description">
                                    <?php _e('The title serves as quiz heading.', 'Cleancoded-Pro-Quiz'); ?>
                                </p>
                            </fieldset>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <?php _e('Hide "Restart quiz" button', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide "Restart quiz" button', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide "View question" button', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide "View question" button', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Display question randomly', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Display question randomly', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Display answers randomly', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Display answers randomly', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Sort questions by category', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Sort questions by category', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Time limit', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Time limit', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label for="time_limit">
                                    <input type="number" min="0" class="small-text" id="time_limit"
                                           value="<?php echo $this->quiz->getTimeLimit(); ?>"
                                           name="timeLimit"> <?php _e('Seconds', 'Cleancoded-Pro-Quiz'); ?>
                                </label>

                                <p class="description">
                                    <?php _e('0 = no limit', 'Cleancoded-Pro-Quiz'); ?>
                                </p>
                            </fieldset>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <?php _e('Statistics', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Statistics', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                    ...
                    <tr id="statistics_ip_lock_tr" style="display: none;">
                        <th scope="row">
                            <?php _e('Statistics IP-lock', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Statistics IP-lock', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Execute quiz only once', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>

                                <legend class="screen-reader-text">
                                    <span><?php _e('Execute quiz only once', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                ...
                                <div id="wpProQuiz_quiz_run_once_type"
                                    ...
                                    <?php _e('This option applies to:', 'Cleancoded-Pro-Quiz');
                                    ...
                                    <label>
                                        ...
                                        <?php _e('all users', 'Cleancoded-Pro-Quiz'); ?>
                                    </label>
                                    <label>
                                        <input name="quizRunOnceType" type="radio"
                                               value="2" <?php echo ($quizRunOnceType == 2) ? 'checked="checked"' : ''; ?>>
                                        <?php _e('registered useres only', 'Cleancoded-Pro-Quiz'); ?>
                                    </label>
                                    <label>
                                        <input name="quizRunOnceType" type="radio"
                                               value="3" <?php echo ($quizRunOnceType == 3) ? 'checked="checked"' : ''; ?>>
                                        <?php _e('anonymous users only', 'Cleancoded-Pro-Quiz'); ?>
                                    </label>
                                    ...
                                    <div id="wpProQuiz_quiz_run_once_cookie" style="margin-top: 10px;">
                                        <label>
                                            ...
                                            <?php _e('user identification by cookie', 'Cleancoded-Pro-Quiz'); ?>
                                        </label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Show only specific number of questions', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                ...
                                <div id="wpProQuiz_showMaxBox" style="display: none;">
                                    ...
                                    <label>
                                        ...
                                        <?php _e('in percent', 'Cleancoded-Pro-Quiz'); ?>
                                    </label>
                                </div>
                            </fieldset>
                        </td>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Prerequisites', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Prerequisites', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Question overview', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Question overview', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                                ...
                                <div class="wpProQuiz_demoBox">
                                    <?php _e('Question overview', 'Cleancoded-Pro-Quiz'); ?>: <a
                                            href="#"><?php _e('Demo', 'Cleancoded-Pro-Quiz'); ?></a>
                                ...
                                <div class="wpProQuiz_demoBox">
                                    <?php _e('Quiz-summary', 'Cleancoded-Pro-Quiz'); ?>: <a
                                            href="#"><?php _e('Demo', 'Cleancoded-Pro-Quiz'); ?></a>
                    ...
                    <tr class="wpProQuiz_reviewQuestionOptions" style="display: none;">
                        <th scope="row">
                            <?php _e('Quiz-summary', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Quiz-summary', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <tr class="wpProQuiz_reviewQuestionOptions" style="display: none;">
                        <th scope="row">
                            <?php _e('Skip question', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Skip question', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <!--
							<tr>
								<th scope="row">
									<?php _e('Admin e-mail notification', 'Cleancoded-Pro-Quiz'); ?>
								</th>
								<td>
									<fieldset>
										<legend class="screen-reader-text">
											<span><?php _e('Admin e-mail notification', 'Cleancoded-Pro-Quiz'); ?></span>
										</legend>
										<label>
                        ...
                        WpProQuiz_Model_Quiz::QUIZ_EMAIL_NOTE_REG_USER); ?>>
											<?php _e('for registered users only', 'Cleancoded-Pro-Quiz'); ?>
										</label>
										<label>
                        ...
                        WpProQuiz_Model_Quiz::QUIZ_EMAIL_NOTE_ALL); ?>>
											<?php _e('for all users', 'Cleancoded-Pro-Quiz'); ?>
										</label>
										<p class="description">
                        ...
                        'Cleancoded-Pro-Quiz'); ?>
							...
							<tr>
								<th scope="row">
									<?php _e('User e-mail notification', 'Cleancoded-Pro-Quiz'); ?>
								</th>
								<td>
									<fieldset>
										<legend class="screen-reader-text">
											<span><?php _e('User e-mail notification', 'Cleancoded-Pro-Quiz'); ?></span>
										</legend>
										<label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Autostart', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Autostart', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
    ...
    private function postBoxResult()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Results text', 'Cleancoded-Pro-Quiz'); ?><?php _e('(optional)',
                    'Cleancoded-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                ...
                <div style="padding-top: 10px; padding-bottom: 10px;">
                    <label for="wpProQuiz_resultGradeEnabled">
                        <?php _e('Activate graduation', 'Cleancoded-Pro-Quiz'); ?>
                ...
                <div style="display: none;" id="resultGrade">
                    <div>
                        <strong><?php _e('Hint:', 'Cleancoded-Pro-Quiz'); ?></strong>
                        <ul style="list-style-type: square; padding: 5px; margin-left: 20px; margin-top: 0;">
                            <li><?php _e('Maximal 15 levels', 'Cleancoded-Pro-Quiz'); ?></li>
                            <li>
                            ...
                            <li><?php _e('Values can also be mixed up', 'Cleancoded-Pro-Quiz'); ?></li>
                    ...
                    <div>
                                ...
                                if ($this->quiz->isResultGradeEnabled() && isset($resultText['text'][$i])) {
                                    ...
                                    <li style="padding: 5px; border: 1px dotted;">
                                        ...
                                        <div
                                            ...
                                            <?php _e('from:', 'Cleancoded-Pro-Quiz'); ?> <input type="text"
                                                                                        name="resultTextGrade[prozent][]"
                                                                                        class="small-text"
                                                                                        value="<?php echo $resultText['prozent'][$i] ?>"> <?php _e('percent',
                                                'Cleancoded-Pro-Quiz'); ?> <?php printf(__('(Will be displayed, when result-percent is >= <span class="resultProzent">%s</span>%%)',
                                                'Cleancoded-Pro-Quiz'), $resultText['prozent'][$i]); ?>
                                            <input type="button" style="float: right;"
                                                   class="button-primary deleteResult"
                                                   value="<?php _e('Delete graduation', 'Cleancoded-Pro-Quiz'); ?>">
                        ...
                        <input type="button" class="button-primary addResult"
                               value="<?php _e('Add graduation', 'Cleancoded-Pro-Quiz'); ?>">
                    </div>
                </div>
                <div id="resultNormal">
                    <?php
                ...
                <h4><?php _e('Custom fields - Variables', 'Cleancoded-Pro-Quiz'); ?></h4>
    ...
    private function postBoxTitle()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Quiz title', 'Cleancoded-Pro-Quiz'); ?><?php _e('(required)',
                    'Cleancoded-Pro-Quiz'); ?></h3>
    ...
    private function postBoxCategory()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Category', 'Cleancoded-Pro-Quiz'); ?><?php _e('(optional)',
                    'Cleancoded-Pro-Quiz'); ?></h3>

            <div class="inside">
                <p class="description">
                    <?php _e('You can assign classify category for a quiz.', 'Cleancoded-Pro-Quiz'); ?>
                </p>

                <p class="description">
                    <?php _e('You can manage categories in global settings.', 'Cleancoded-Pro-Quiz'); ?>
                </p>

                <div>
                    <select name="category">
                        <option value="-1">--- <?php _e('Create new category', 'Cleancoded-Pro-Quiz'); ?>----
                        </option>
                        <option
                                value="0" <?php echo $this->quiz->getCategoryId() == 0 ? 'selected="selected"' : ''; ?>>
                            --- <?php _e('No category', 'Cleancoded-Pro-Quiz'); ?> ---
                        </option>
                        <?php
    ...
    private function postBoxQuizDescription()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Quiz description', 'Cleancoded-Pro-Quiz'); ?><?php _e('(required)',
                    'Cleancoded-Pro-Quiz'); ?></h3>

            <div class="inside">
                <p class="description">
                    <?php _e('This text will be displayed before start of the quiz.', 'Cleancoded-Pro-Quiz'); ?>
                </p>
                <?php
    ...
    private function postBoxResultOptions()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Result-Options', 'Cleancoded-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Show average points', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Show average points', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                                ...
                                <p class="description">
                                    <?php _e('Statistics-function must be enabled.', 'Cleancoded-Pro-Quiz'); ?>
                                </p>

                                <div class="wpProQuiz_demoBox">
                                    <a href="#"><?php _e('Demo', 'Cleancoded-Pro-Quiz'); ?></a>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Show category score', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Show category score', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide correct questions - display', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide correct questions - display', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide quiz time - display', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide quiz time - display', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide score - display', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide score - display', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
    ...
    private function postBoxQuestionOptions()
    {
        ...
        <div class="postbox">
            <h3 class="hndle"><?php _e('Question-Options', 'Cleancoded-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Show points', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Show points', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Number answers', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Number answers', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide correct- and incorrect message', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide correct- and incorrect message', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Correct and incorrect answer mark', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Correct and incorrect answer mark', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Force user to answer each question', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Force user to answer each question', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide question position overview', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide question position overview', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Hide question numbering', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide question numbering', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Display category', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Display category', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                    <input type="checkbox" value="1"
    ...
    private function postBoxLeaderboardOptions()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Leaderboard', 'Cleancoded-Pro-Quiz'); ?><?php _e('(optional)', 'Cleancoded-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                ...
                <p>
                    <?php _e('The leaderboard works independent from internal statistics function.', 'Cleancoded-Pro-Quiz'); ?>
                </p>
                <table class="form-table">
                    <tbody id="toplistBox">
                    <tr>
                        <th scope="row">
                            <?php _e('Leaderboard', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Who can sign up to the list', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('insert automatically', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('display captcha', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <label>
                            ...
                            <p class="description" style="color: red;">
                                <?php _e('This option requires additional plugin:', 'Cleancoded-Pro-Quiz'); ?>
                                <a href="http://wordpress.org/extend/plugins/really-simple-captcha/" target="_blank">Really
                                    Simple CAPTCHA</a>
                            </p>
                            <?php if ($this->captchaIsInstalled) { ?>
                                <p class="description" style="color: green;">
                                    <?php _e('Plugin has been detected.', 'Cleancoded-Pro-Quiz'); ?>
                                </p>
                            <?php } else { ?>
                                <p class="description" style="color: red;">
                                    <?php _e('Plugin is not installed.', 'Cleancoded-Pro-Quiz'); ?>
                                </p>
                            <?php } ?>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('How many entries should be displayed', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <div>
                                <label>
                                    ...
                                    <?php _e('Entries', 'Cleancoded-Pro-Quiz'); ?>
                                </label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <?php _e('Automatically display leaderboard in quiz result', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <div style="margin-top: 6px;">
                                <?php _e('Where should leaderboard be displayed:', 'Cleancoded-Pro-Quiz'); ?>
                                <label style="margin-right: 5px; margin-left: 5px;">
                                    <input type="radio" name="toplistDataShowIn"
                                           value="0" <?php echo ($this->quiz->getToplistDataShowIn() == 0) ? 'checked="checked"' : ''; ?>>
                                    <?php _e('don\'t display', 'Cleancoded-Pro-Quiz'); ?>
                                </label>
                                <label>
                                    <input type="radio" name="toplistDataShowIn"
                                           value="1" <?php echo ($this->quiz->getToplistDataShowIn() == 1) ? 'checked="checked"' : ''; ?>>
                                    <?php _e('below the "result text"', 'Cleancoded-Pro-Quiz'); ?>
                                </label>
                                ...
                                <label>
                                    ...
                                    <?php _e('in a button', 'Cleancoded-Pro-Quiz'); ?>
                                </label>
    ...
    private function postBoxQuizMode()
    {
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Quiz-Mode', 'Cleancoded-Pro-Quiz'); ?><?php _e('(required)', 'Cleancoded-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                <table style="width: 100%; border-collapse: collapse; border: 1px solid #A0A0A0;"
                    ...
                    <thead>
                    <tr>
                        <th style="width: 25%;"><?php _e('Normal', 'Cleancoded-Pro-Quiz'); ?></th>
                        <th style="width: 25%;"><?php _e('Normal + Back-Button', 'Cleancoded-Pro-Quiz'); ?></th>
                        <th style="width: 25%;"><?php _e('Check -> continue', 'Cleancoded-Pro-Quiz'); ?></th>
                        <th style="width: 25%;"><?php _e('Questions below each other', 'Cleancoded-Pro-Quiz'); ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        ...
                        <td><label><input type="radio" name="quizModus"
                                    ...
                                    WpProQuiz_Model_Quiz::QUIZ_MODUS_CHECK); ?>> <?php _e('Activate', 'Cleancoded-Pro-Quiz'); ?>
                            </label></td>
                        <td><label><input type="radio" name="quizModus"
                    ...
                    <tr>
                        ...
                        <td>
                            <?php _e('Allows to use the back button in a question.', 'Cleancoded-Pro-Quiz'); ?>
                        </td>
                        <td>
                            <?php _e('Shows "right or wrong" after each question.', 'Cleancoded-Pro-Quiz'); ?>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <?php _e('How many questions to be displayed on a page:', 'Cleancoded-Pro-Quiz'); ?><br>
                            <input type="number" name="questionsPerPage"
                                   value="<?php echo $this->quiz->getQuestionsPerPage(); ?>" min="0">
									<span class="description">
										<?php _e('(0 = All on one page)', 'Cleancoded-Pro-Quiz'); ?>
									</span>
                        </td>
                    </tr>
                    </tbody>
    ...
    private function postBoxForms()
    {
        ...
        ?>
        <div class="postbox">
            <h3 class="hndle"><?php _e('Custom fields', 'Cleancoded-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                ...
                <p class="description">
                    <?php _e('The statistic function have to be enabled.', 'Cleancoded-Pro-Quiz'); ?>
                </p>
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Custom fields enable', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Custom fields enable', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <label>
                                ...
                                <p class="description">
                                    <?php _e('If you enable this option, custom fields are enabled.', 'Cleancoded-Pro-Quiz'); ?>
                                </p>
                            </fieldset>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <?php _e('Display position', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Display position', 'Cleancoded-Pro-Quiz'); ?></span>
                                </legend>
                                <?php _e('Where should the fileds be displayed:', 'Cleancoded-Pro-Quiz'); ?>
                                <label>
                                    <input type="radio"
                                    ...
                                    <?php _e('On the quiz startpage', 'Cleancoded-Pro-Quiz'); ?>
                                ...
                                <label>
                                    ...
                                    <?php _e('At the end of the quiz (before the quiz result)', 'Cleancoded-Pro-Quiz'); ?>
                ...
                <div style="margin-top: 10px; padding: 10px; border: 1px solid #C2C2C2;">
                    <table style=" width: 100%; text-align: left; " id="form_table">
                        ...
                        <tr>
                            <th>#ID</th>
                            <th><?php _e('Field name', 'Cleancoded-Pro-Quiz'); ?></th>
                            <th><?php _e('Type', 'Cleancoded-Pro-Quiz'); ?></th>
                            <th><?php _e('Required?', 'Cleancoded-Pro-Quiz'); ?></th>
                            <th>
                                <?php _e('Show in statistic table?', 'Cleancoded-Pro-Quiz'); ?>
                                <div style="display: inline-block;" class="wpProQuiz_demoBox">
                                    <a href="#"><?php _e('Demo', 'Cleancoded-Pro-Quiz'); ?></a>
                        ...
                        <?php foreach ($forms as $form) {
                            ...
                            <tr <?php echo $index++ == 0 ? 'style="display: none;"' : '' ?>>
                                ...
                                <td style="position: relative;">
                                    ...
                                    <a href="#" class="editDropDown"><?php _e('Edit list', 'Cleancoded-Pro-Quiz'); ?></a>
                                    ...
                                    <div class="dropDownEditBox"
                                        ...
                                        <h4><?php _e('One entry per line', 'Cleancoded-Pro-Quiz'); ?></h4>
                                        ...
                                        <input type="button" value="<?php _e('OK', 'Cleancoded-Pro-Quiz'); ?>"
                                               class="button-primary">
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="button" name="form_delete"
                                           value="<?php _e('Delete', 'Cleancoded-Pro-Quiz'); ?>" class="button-secondary">
                    ...
                    <div style="margin-top: 10px;">
                        <input type="button" name="form_add" id="form_add"
                               value="<?php _e('Add field', 'Cleancoded-Pro-Quiz'); ?>" class="button-secondary">
                    </div>
                </div>
            </div>
        </div>
    ...
    private function postBoxAdminEmailOption()
    {
        ...
        <div class="postbox" id="adminEmailSettings">
            <h3 class="hndle"><?php _e('Admin e-mail settings', 'Cleancoded-Pro-Quiz'); ?></h3>
            ...
            <div class="inside">
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('From:', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <label>
                            ...
                            <!-- 								<p class="description"> -->
                            <?php //_e('Server-Adresse empfohlen, z.B. info@YOUR-PAGE.com', 'Cleancoded-Pro-Quiz');
                            ?>
                            <!-- 								</p> -->
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <?php _e('Subject:', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('HTML', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <label>
                    ...
                    <tr>
                        <th scope="row">
                            <?php _e('Message body:', 'Cleancoded-Pro-Quiz'); ?>
                        </th>
                        <td>
                            <?php
                            ...
                            <div style="padding-top: 10px;">
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        <th style="padding: 0;">
                                            <?php _e('Allowed variables', 'Cleancoded-Pro-Quiz'); ?>
                                        </th>
                                        <th style="padding: 0;">
                                            <?php _e('Custom fields - Variables', 'Cleancoded-Pro-Quiz'); ?>
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                                        <td style="vertical-align: top;">
                                            <ul>
                                                <li><span>$userId</span> - <?php _e('User-ID', 'Cleancoded-Pro-Quiz'); ?></li>
                                                <li><span>$username</span> - <?php _e('Username', 'Cleancoded-Pro-Quiz'); ?>
                                                </li>
                                                <li><span>$quizname</span> - <?php _e('Quiz-Name', 'Cleancoded-Pro-Quiz'); ?>
                                                </li>
                                                <li><span>$result</span> - <?php _e('Result in precent',
                                                        'Cleancoded-Pro-Quiz'); ?></li>
                                                <li><span>$points</span> - <?php _e('Reached points', 'Cleancoded-Pro-Quiz'); ?>
                                                </li>
    ...
    private function postBoxUserEmailOption()
    {
        ...
        <div class="postbox" id="userEmailSettings">
            <h3 class="hndle"><?php _e('User e-mail settings', 'Cleancoded-Pro-Quiz'); ?></h3>
