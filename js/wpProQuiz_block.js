    ...
    function createSelectElment(el, props, quizner, withServerRender) {
        return el(
            ...
            withServerRender ? el(ServerSideRender, {
                key: 'editable',
                block: 'Cleancoded-Pro-Quiz/quiz',
                attributes: props.attributes
            }) : null
        )
    }

    wp.blocks.registerBlockType('Cleancoded-Pro-Quiz/quiz', {
        title: 'Cleancoded-Pro-Quiz',
        icon: 'universal-access-alt',
        category: 'common',
        example: {},
        edit: withSelect(function (select) {
            var attr = select('core/blocks').getBlockType('Cleancoded-Pro-Quiz/quiz').attributes;
